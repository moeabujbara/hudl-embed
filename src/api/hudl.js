...
export const indexPlaylistMedia = (playlistId) => {
    return axios.get(`https://hv-api-staging.herokuapp.com/user/playlists/${playlistId}/playlists_media`)
}

export const showUserAlbum = (albumId) => {
    return axios.get(`https://hv-api-staging.herokuapp.com/user/albums/${albumId}/album_media`)
}
